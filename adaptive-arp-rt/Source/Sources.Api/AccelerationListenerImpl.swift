...
listener and subsequently, the listener will be deactivated and removed from the internal list of listeners.
    ...
    */
    public func onError(error : IAccelerationListenerError) { 
        var param0 : String = "IAccelerationListenerError.toObject(JSON.parse(" + JSONUtil.escapeString("{ \"value\": \"\(error.toString()) }") + "))"
    ...
    */
    public func onResult(acceleration : Acceleration) { 
        var param0 : String = "Acceleration.toObject(JSON.parse(" + JSONUtil.escapeString(Acceleration.Serializer.toJSON(acceleration)) + "))"
    ...
    */
    public func onWarning(acceleration : Acceleration, warning : IAccelerationListenerWarning) { 
        var param0 : String = "Acceleration.toObject(JSON.parse(" + JSONUtil.escapeString(Acceleration.Serializer.toJSON(acceleration)) + "))"
        var param1 : String = "IAccelerationListenerWarning.toObject(JSON.parse(" + JSONUtil.escapeString("{ \"value\": \"\(warning.toString()) }") + "))"
