...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, willFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        logger.log(ILoggingLogLevel.INFO, message: OSImpl().getOSInfo()!.getVersion()!)
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:didFinishLaunchingWithOptions")
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:applicationDidBecomeActive")
    }
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:applicationWillResignActive")
    }
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:applicationDidEnterBackground")
    }
    ...
    func applicationWillEnterForeground(application: UIApplication) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:applicationWillEnterForeground")
    }
    ...
    func application(application: UIApplication, willChangeStatusBarOrientation newStatusBarOrientation: UIInterfaceOrientation, duration: NSTimeInterval) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:willChangeStatusBarOrientation")
    }
    ...
    func application(application: UIApplication, didChangeStatusBarOrientation oldStatusBarOrientation: UIInterfaceOrientation) {
        ...
        logger.log(ILoggingLogLevel.INFO, message: "application:didChangeStatusBarOrientation")
    }
